...
import 'package:vinyl_app/screens/details/Description/body.dart';
...
class Desc_page extends StatelessWidget {
  final Product product;
  Desc_page({Key key, @required this.product}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: NavDrawer(),
      appBar: buildAppBar(),
      body: desc_page(product: product,),
